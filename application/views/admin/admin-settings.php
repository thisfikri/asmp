...
<section class="casual-theme activity-page main-contents">
    ...
    <div class="casual-theme settings-container">
        <div class="form-section company">
            <h2>~ Aplikasi > Perusahaan ~</h2>
            <form action="javascript:void(0)" method="post" id="settingsForm">
                <label for="company_name">Nama Perusahaan:</label>
                <input type="text" name="company_name" id="companyName" value="<?php echo $app_settings[0]->mail_document_heading;?>">
                <label for="company_address">Alamat Perusahaan:</label>
                <input type="text" name="company_address" id="companyAddress" value="<?php echo $app_settings[0]->mail_document_address;?>">
                <label for="company_contact">Kontak Perusahaan:</label>
                <input type="text" name="company_contact" id="companyContact" value="<?php echo $app_settings[0]->mail_document_contact;?>">
                <button type="submit" name="app_settings" class="button save-settings-btn"><i class="fa fa-save"></i> Simpan</button>
            </form>
        </div>
