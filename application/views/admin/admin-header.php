...
<body class="casual-theme" id="adminDashboard">
    ...
    <div class="casual-theme activity-page options-dropdown">
        <ul>
            <li><a href="<?php echo site_url('admin/settings');?>" class="preference-btn"><i class="fa fa-wrench"></i> Preference</a></li>
    ...
    <nav class="casual-theme activity-page nav sidebar">
        ...
        <ul>
            <li><a href="<?php echo site_url('admin/dashboard');?>"><i class="fa fa-tachometer-alt"></i> Dashboard</a></li>
            <li><a href="<?php echo site_url('admin/user-management');?>"><i class="fa fa-users"></i> User Management</a></li>
