...
<section class="casual-theme activity-page main-contents">
        ...
        <div class="activity-page page-title">
            <h1>_<i class="fa fa-inbox"></i> <?php echo $this->theme->get_page_title('incoming-mail'); ?>_</h1>
        </div>
        ...
        <div class="casual-theme table-container" id="incomingMail">
            ...
            <table class="item-list" border="1" id="mailAction">
                ...
                <tr class="item id1">
                    ...
                    <td><p class="im-status"><i class="fa fa-envelope"></i> Baru</p></td>
                    <td>18/12/2018</td>
                    <td>
                ...
                <tr class="item id2">
                    ...
                    <td><p class="im-status"><i class="fa fa-envelope-open"></i> Lawas</p></td>
                    <td>18/12/2018</td>
                    <td>
