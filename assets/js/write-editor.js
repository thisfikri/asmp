$(document).ready(function() {
	...
	containerSelector2 = '.edit-om-modal';
	...
	$(containerSelector2 + ' .modal2ndlayer .mail-modal-form').submit(function() {
        var
			...
			pDFDocAD = createPDFDocAD(matchingObject);
			pDFDocAD = pDFDocAD.join('|');
			$(containerSelector2 + ' .modal2ndlayer .mail-modal-form input[name=editor_data]').val(iframeData);
